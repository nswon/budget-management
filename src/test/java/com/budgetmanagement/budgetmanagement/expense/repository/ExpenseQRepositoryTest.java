...
@SpringBootTest
@Transactional
public class ExpenseQRepositoryTest {

    @Autowired
    private ExpenseQRepository expenseQRepository;
    ...
    class getTotalAmount {
        ...
        void success() {
            ...
            //when
            int totalAmount = expenseQRepository.getTotalAmount(user.getId(), null, 0, 10000);
    ...
    void getCategoryTotalAmounts() {
        ...
        //when
        List<ExpenseCategoryTotalAmountResponse> response = expenseQRepository.getCategoryTotalAmounts(user.getId(), null, 0, 10000);

        //then
        int totalAmount = response.stream()
                .mapToInt(ExpenseCategoryTotalAmountResponse::totalAmount)
                .sum();
    ...
    class getExpenses {
        ...
        void success() {
            ...
            //when
            List<ExpenseResponse> response = expenseQRepository.getExpenses(user.getId(), null, 0, 10000);
        ...
        void success3() {
            ...
            //when
            List<ExpenseResponse> response = expenseQRepository.getExpenses(user.getId(), "식비", 0, 10000);
        ...
        void success4() {
            ...
            List<ExpenseResponse> response = expenseQRepository.getExpenses(user.getId(), null, minAmount, maxAmount);
